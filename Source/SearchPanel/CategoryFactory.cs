...
namespace SearchPanel
{
	public class CategoryFactory
	{
		...
		private SearchItemPackFactory searchItemFactory;

		protected readonly SearchItemPackFactory defaultItemFactory;
		...
		public CategoryFactory(SearchItemPackFactory defaultSearchItemFactory)
		{
			defaultItemFactory = defaultSearchItemFactory;
		...
		public virtual IEnumerable<Category> GetCategories()
		{
			...
			searchItemFactory = defaultItemFactory;
